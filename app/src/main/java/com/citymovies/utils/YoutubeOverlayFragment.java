...
public class YoutubeOverlayFragment extends YouTubePlayerFragment implements YouTubePlayer.OnInitializedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            this.attachedListView = getActivity().findViewById(R.id.scrollView);
        ...
        //actionBarView = findToolbar(getActivity());
    }

    private static ViewGroup findToolbar(ViewGroup viewGroup, Activity activity) {
...
//        toolbar.setBackground(R.color.material_blue_grey_800);
        ...
        AppCompatActivity objactivity = (AppCompatActivity) activity;
        objactivity.setSupportActionBar(toolbar);
        objactivity.getSupportActionBar().setDisplayHomeAsUpEnabled(true);
...
//        }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        actionBarView = findToolbar(viewGroup, getActivity());
        Log.e("init", "inmit");
    ...
    public static class Builder {
        ...
        public YoutubeOverlayFragment buildAndAdd() {
            ...
            FragmentManager fragmentManager = activity.getFragmentManager();
            View scrollableView = activity.findViewById(R.id.scrollView);
            //setScrollableViewId(R.id.scrollView);
            YoutubeOverlayFragment yt = (YoutubeOverlayFragment) fragmentManager.findFragmentByTag(YoutubeOverlayFragment.class.getName());
            if (yt != null) {
